...
def load_and_update_mappings():
    ...
    try:
        ...
        # Point to src/config_manager/mapping_config.json
        # src/data_parser/../config_manager/mapping_config.json
        json_path = os.path.join(base_dir, '..', 'config_manager', 'mapping_config.json')

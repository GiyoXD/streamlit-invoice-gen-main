...
from core.database.user_repository import (
    get_security_stats_data as get_security_stats,
    log_security_event, log_business_activity,
    get_business_activities_data as get_business_activities,
    get_activity_summary_data as get_activity_summary,
    get_all_users, update_user_role, delete_user,
    get_security_events_data as get_security_events,
    get_active_tokens, revoke_token,
    get_storage_stats_data as get_storage_stats
)
from core.database.connection import USER_DB_PATH
from core.auth.service import (
    create_user, generate_registration_token,
    create_registration_token, backup_database, restore_database,
    get_system_health, rotate_logs
)
from app.components.auth_ui import setup_page_auth, create_admin_check_decorator

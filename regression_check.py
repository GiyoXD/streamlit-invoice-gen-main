...
def test_prepare_data_rows_regression():
    print("Testing prepare_data_rows with dict input (legacy structure)...")
    
    # Mock data source as a dict (legacy structure)
    data_source = {
        ("PO1", "Item1"): {"col_po": "PO1", "col_item": "Item1", "col_qty": 10},
        ("PO2", "Item2"): {"col_po": "PO2", "col_item": "Item2", "col_qty": 20}
    }
    ...
    dynamic_mapping_rules = {
        ...
        "col_desc": {"column": "col_desc", "fallback": "DESC"}
    }
...
if __name__ == "__main__":
    test_prepare_data_rows_regression()
